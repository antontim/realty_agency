...
public class QuestionsDao {
    ...
    public Questions merge(Questions detachedInstance) {
        ...
        try {
            Questions result = (Questions) sessionFactory.getCurrentSession()
    ...
    public Questions findById(java.lang.Integer id) {
        ...
        try {
            Questions instance = (Questions) sessionFactory.getCurrentSession()
                    .get("com.realty.agency.domain.Questions", id);
            if (instance == null) {
    ...
    public List<Questions> findByExample(Questions instance) {
        log.debug("finding Questions instance by example");
        try {
            List<Questions> results = (List<Questions>) sessionFactory
                    .getCurrentSession()
                    .createCriteria("com.realty.agency.domain.Questions")
